...
struct Utilies {
  static const std::string points[SIZE] = { "msk_AP","msk_TS","msk_WH","mzh_TS",
  ...
  static const std::map<std::string, int> towns = {
  	{"Moscow", 2},
  	{"Mozhaisk", 4},
  	{"Zvenigorod", 5},
  	{"Nizhniy Novgorod", 8},
  ...
  static const std::tuple<int, int, double> table_cost[21] = {
  	{500, 300, 100},
  	{200, 100, 500},
  	{100, 60, 50},
  	{0, 0, 0},
  ...
  static const int matrix_dist[SIZE][SIZE] = {
